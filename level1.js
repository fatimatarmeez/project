...
function showAlert() {
    Swal.fire({
        ...
        text: ' عزيزتي عليك ِ بتركيب الصورة التي تدل على إحدى صفات الرسول الأكرم"ص" المذكورة في القرآن الكريم. ملاحظة :تبديل قطع الصورة يكون من خلال استخدام الإصبعين ',
